...
@Mod.EventBusSubscriber(modid = "emberfall", bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            ...
            ItemProperties.register(
                    ...
                    new ResourceLocation("emberfall", "charge_state"),
            ...
            ItemProperties.register(
                    ModItems.RESONANCE_GEM.get(),
                    new ResourceLocation("emberfall", "gem_type"),
                    (stack, level, entity, seed) ->
